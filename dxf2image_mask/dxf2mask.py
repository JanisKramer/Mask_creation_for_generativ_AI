...
Usage
    ...
    # Or specify the CSV directly (6 rows x,y; header allowed; comma/semicolon):
    python dxf2mask.py --src-csv six_points.csv
...
def run(image_path: str, dxf_path: str, out_mask_path: str, *, layer: Optional[str] = None, line_snap_tol: float = 1e-3, src_corners: Optional[str] = None, src_csv: Optional[str] = None, save_diag: Optional[str] = None, use_ransac: bool = False, ransac_thresh: float = 4.0, save_overlay: Optional[str] = None) -> None:
    # Load image
